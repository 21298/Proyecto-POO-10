...
public class display {
    ...
    public void addPaciente() throws IOException{
        ...
        listaMedicamento.add(medica); 
            ...
            archi = new File("C:\\Users\\S.Solorzano\\Documents\\Universidad\\Segundo semestre\\POO\\Proyecto - final\\Mis avances\\Fase 3\\pacientesss.txt");
            if(!archi.exists()){
            try{
                archi.createNewFile();
                archivo = new FileWriter("C:\\Users\\S.Solorzano\\Documents\\Universidad\\Segundo semestre\\POO\\Proyecto - final\\Mis avances\\Fase 3\\pacientesss.txt",true);
