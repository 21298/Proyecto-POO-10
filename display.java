...
public class display {
    ...
    public void addPaciente() throws IOException{
        ...
        listaPaciente.add(paciente); 
            ...
            try{
                archi.createNewFile();
                archivo = new FileWriter("C:\\Users\\Abner Garcia\\Documents\\UVG 2 SEMESTRE\\CURSOS\\Progra Orientada a Objetos\\java\\pacientesss.txt",true);
                escritor = new PrintWriter(archivo);
                
                escritor.println(name+","+DPI+","+Sangre+","+Diagnostico);
                escritor.close();
                archivo.close();
            }
            ...
            try{
                archivo = new FileWriter("C:\\Users\\Abner Garcia\\Documents\\UVG 2 SEMESTRE\\CURSOS\\Progra Orientada a Objetos\\java\\pacientesss.txt",true);
                escritor = new PrintWriter(archivo);
                escritor.println("Nombre,DPI,Sangre,Diagnostico");
                escritor.println(name+","+DPI+","+Sangre+","+Diagnostico);
                escritor.close();
                archivo.close();
            }
